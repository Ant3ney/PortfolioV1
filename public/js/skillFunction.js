...
var deleteSkillIcons = document.querySelectorAll(
   '#skill-list .del-icon-container'
);
...
class List {
   constructor(id) {
      ...
      this.deleteListBtns =
         this.listContainer.querySelectorAll(`.list-delete-icon`);
      this.index = {
   ...
   deleteIconPressdOfIndex(i) {
      let iconContainer = this.listContainer.getElementsByClassName(
   ...
   addListClicked() {
      ...
      const listContainer = this.listContainer.querySelector(
      ...
      const iconContainer = this.listContainer
         .querySelector('.del-icon-container')
         .cloneNode(true);
...
function deleteIconPressOfIndex(i) {
   var iconContainer = document.getElementsByClassName(
