...
router.get('/new', (req, res) => {
   res.status(200).render('experience/new', {
      settings: {
...
router.get('/:id', (req, res) => {
   ...
   Experience.findById(id).then(experience => {
...
router.get('/:id/edit', (req, res) => {
   ...
   Experience.findById(id)
      ...
      .catch(err => {
         let message =
            'Something went wrong in edit experience route because ' +
            err.message;
...
router.get('/', (req, res) => {
   Experience.find({}, (err, experiences) => {
      if (err) {
         ...
         res.status(200).render('experience/index', {
